...
possibleConditions = ['allSteps'] #['swingLengthLinear_lastRec_20_80']#'allSteps']#,'swingDurationLastRec20-80','swingLengthLastRec20-80', 'indecisiveSteps', 'not_indecisiveSteps']
...
for l, condition in enumerate(possibleConditions):
    ...
    pickleFileName3 = groupAnalysisDir + f'/FR_{recordings}{variable}Response.p'
    ...
    #cPV.psthGroupFigure_cell_based_supp(figVersion,recordings[3:], df_psth, df_cells,condition, pawNb)
    cPV.psthGroupFigure_cell_based_suppV2(figVersion,recordings[3:], df_psth, df_cells,condition, pawNb,allModTraces,variable)